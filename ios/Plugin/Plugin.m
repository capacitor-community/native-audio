...
CAP_PLUGIN(NativeAudio, "NativeAudio",
             ...
             CAP_PLUGIN_METHOD(preloadSimple, CAPPluginReturnPromise);
             CAP_PLUGIN_METHOD(preloadComplex, CAPPluginReturnPromise);
             ...
             CAP_PLUGIN_METHOD(isLoaded, CAPPluginReturnPromise);
)
